...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:15%">
    ...
    <a href="#" class="w3-bar-item w3-button w3-green">Operator</a>
  ...
  <div style="margin-left:15%">
    ...
    <div class="w3-container w3-teal">
      <h2>เพิ่ม ลบ แก้ไขข้อมูลในฐานข้อมูล Operator</h2>
    </div>
      ...
      <table class="table ">
          ...
          <?php $index = 1; if($row > 0) {
            ...
            <tr>
              ...
              <td><button class="btn" onclick="alertModalEdit('<?php echo $row['op_id']; ?>', '<?php echo $row['op_name']; ?>')"><i class="fa fa-pencil"></i></button></td>
              <td><button class="btn" onclick="alertConfirmDelete('<?php echo $row['op_id']; ?>')"><i class="fa fa-trash"></i></button></td>
            </tr>
            <?php $index++; 
          } while ($row = mysqli_fetch_assoc($result)); ?>
          <?php } else { ?>
            <tr>
              <td colspan="7" class="text-center">ไม่พบข้อมูล Operator</td></tr>
          <?php } ?>
          </tbody>
      </table>
    </div>
