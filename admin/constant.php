...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:15%">
    ...
    <a href="#" class="w3-bar-item w3-button w3-green">Value/Constant</a>
  ...
  <div style="margin-left:15%">
    ...
    <div class="w3-container w3-teal">
      <h2>เพิ่ม ลบ แก้ไขข้อมูลในฐานข้อมูล Value/Constant</h2>
    </div>
    ...
    <div class="w3-container mt-3">          
      <table class="table ">
          ...
          <?php } else { ?>
            <tr>
              <td colspan="7" class="text-center">ไม่พบข้อมูล Value/Constant</td></tr>
          <?php } ?>
          </tbody>
      </table>
    </div>
