...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:15%">
    <h3 class="w3-bar-item w3-block">จัดการข้อมูล</h3>
    ...
    <a href="adminwow.php" class="w3-bar-item w3-button w3-hover-green">WOW</a>
    <a href="#" class="w3-bar-item w3-button w3-green">Role ID</a>
  ...
  <div style="margin-left:15%">
    ...
    <div class="w3-container w3-teal">
      <h2>เพิ่ม ลบ แก้ไขข้อมูลในฐานข้อมูล Roleid</h2>
    </div>
      ...
      <table class="table ">
          ...
          <?php $index = 1; if($row > 0) {
            ...
            <tr>
              ...
              <td><button class="btn" onclick="alertModalEdit('<?php echo $row['role_id']; ?>', '<?php echo $row['role_name']; ?>')"><i class="fa fa-pencil"></i></button></td>
              <td><button class="btn" onclick="alertConfirmDelete('<?php echo $row['role_id']; ?>')"><i class="fa fa-trash"></i></button></td>
            </tr>
            <?php $index++; 
          } while ($row = mysqli_fetch_assoc($result)); ?>
          <?php } else { ?>
            <tr>
              <td colspan="7" class="text-center">ไม่พบข้อมูล Role id</td></tr>
          <?php } ?>
          </tbody>
      </table>
    </div>
